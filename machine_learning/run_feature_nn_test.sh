...
apptainer exec --nv /mimer/NOBACKUP/priv/chair/sarssw/apptainer_sarssw.sif  \
    ...
    --data_dir /mimer/NOBACKUP/priv/chair/sarssw/IW_VV_VH_100k \
    --dataframe_path /mimer/NOBACKUP/priv/chair/sarssw/sar_dataset_features_labels_22_may/sar_dataset.pickle \
    --checkpoint '/mimer/NOBACKUP/priv/chair/sarssw/final_only_feat/version_0/checkpoints/best_val_loss-epoch=41-val_loss=0.31.ckpt' \
    --gpus 1
