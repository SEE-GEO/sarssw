...
apptainer exec --nv /mimer/NOBACKUP/priv/chair/sarssw/apptainer_sarssw.sif  \
    ...
    --checkpoint "/mimer/NOBACKUP/priv/chair/sarssw/final_img_feat/version_0/checkpoints/best_val_loss-epoch=41-val_loss=0.28.ckpt" \
    --save_dir "/mimer/NOBACKUP/priv/chair/sarssw/result_predictions" \
    --gpus 1
