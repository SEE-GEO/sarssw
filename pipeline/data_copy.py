...
if __name__ == "__main__":
    ...
    parser.add_argument('--limit', type=int, default=None, help='Set a limit on the number of files to save, this limit is applies separately to the datasets')
    ...
    for dataset_name in dataset_filter:
        ...
        copy_imgs = all_imgs.intersection(set(fl_df_dataset['file_name'].unique()[:args.limit]))
